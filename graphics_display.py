...
class InfoPane:
    ...
    def set_team(self, is_blue):
        ...
        self.teamText = text( self.to_screen(300, 0  ), self.text_color, text, "Times", self.font_size, "bold")
...
class PacmanGraphics:
    ...
    def make_window(self, width, height):
        ...
        begin_graphics(screen_width, screen_height, BACKGROUND_COLOR, "CS4804 Pacman (Ghostbusters Edition)")
        ...
        for x_num, x in enumerate(food_matrix):
            ...
            for y_num, cell in enumerate(x):
                if cell: # There's food here
                    ...
                    dot = circle(screen, FOOD_SIZE * self.grid_size, outline_color = color, fill_color = color, width = 1)
    ...
    def draw_capsules(self, capsules):
        ...
        for capsule in capsules:
            ...
            dot = circle( (screen_x, screen_y), CAPSULE_SIZE * self.grid_size, outline_color = CAPSULE_COLOR, fill_color = CAPSULE_COLOR, width = 1)
