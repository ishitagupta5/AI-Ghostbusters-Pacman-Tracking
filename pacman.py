...
class ClassicGameRules:
    ...
    def get_max_time_warning(self, agent_index):
        return 0
...
def read_command( argv ):
    ...
    no_keyboard = options.game_to_replay == None and (options.test_graphics or options.quiet_graphics)
